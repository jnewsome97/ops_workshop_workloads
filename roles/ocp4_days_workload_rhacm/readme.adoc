= ocp4_days_workload_rhacm - Deploys RH ACM
...
* Other variables:
** *ocp4_days_workload_rhacm_acm_project*: The name of the project where ACM is deployed. Default: `open-cluster-management`
** *ocp4_days_workload_rhacm_acm_release*: ACM release to be deployed. Default: `release-1.0`
** *ocp4_days_workload_rhacm_docker_registry*: ACM Container Registry. Default: `registry.access.redhat.com/rhacm1-tech-preview`
...
WORKLOAD="ocp4_days_workload_rhacm"
GUID=1001
